...
import { columns as tableColumns } from "~/components/operators/mine/columns"; // Renamed to avoid conflict
import { PermissionConstants } from "~/constants/permissions";

const {getMerchantOperatorsByBranchId} = useOperators()
...
const fetchMerchantOperatorsData = async () => {
  try {
    ...
    const merchantOperators = await getMerchantOperatorsByBranchId(myBranchId.value, 0,10000);
