...
<template>
  ...
  >
    ...
    <div
      class="w-full md:w-1/2 lg:w-2/5 xl:w-1/3 min-h-max gap-4 flex flex-col"
    >
      ...
      <div class="flex flex-col items-center py-8 px-6">
        ...
        >
          ...
          <span>
            ({{ paymentResponse?.currencyCode }}-{{
              paymentResponse?.payerAccountNumber?.slice(-4)
            }}) for
          </span>
          ...
          <span>
            ({{ paymentResponse?.currencyCode }}-{{
              paymentResponse?.merchantAccountNumber?.slice(-4)
            }})</span
          >
        </UiDialogDescription>
        <!-- Details -->
        ...
        >
          ...
          <div class="flex justify-between mb-2">
            ...
            <span>{{
              formatDate(
                paymentResponse?.time || paymentResponse?.completedDate
              )
            }}</span>
          </div>
          <div class="flex justify-between mb-2">
          ...
          <div class="flex justify-between mb-2">
            ...
            <span
              >{{ paymentResponse?.currencyCode }}
              {{ paymentResponse?.tipAmount }}</span
            >
          </div>
