...
<template>
  <div
    class="{`w-full h-60 md:h-[500px] p-10 bg-destructive/20 shadow-none border-none rounded-xl border-[1px] max-h-screen flex flex-col gap-2 justify-center items-center ${className}`}"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      viewBox="0 0 24 24"
      class="w-32 pb-4 text-destructive"
    >
      <path
        fill="currentColor"
