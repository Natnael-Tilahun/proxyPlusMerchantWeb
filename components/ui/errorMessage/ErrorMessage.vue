...
<template>
  <div
    class="{`w-full h-60 md:h-[500px] p-10 bg-[#f8dff3] shadow-none border-none dark:bg-[#1a0716] rounded-xl border-[1px] max-h-screen flex flex-col gap-2 justify-center items-center ${className}`}"
  >
    <svg
