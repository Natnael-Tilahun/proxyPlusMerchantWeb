...
const { getTransactionById } = useTransactions({ autoFetch: false });
    ...
    >
      ...
      >
        ...
        <TransactionsTransactionDetailItem
          ...
          :value="
            transactionData?.payerAccountNumber?.length &&
            formatAccountNumber(
              typeof transactionData.payerAccountNumber === 'string'
                ? transactionData.payerAccountNumber
                : '-'
            )
          "
        />
